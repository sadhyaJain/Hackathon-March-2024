      ...
      <div style={{ width: '80%', maxWidth: '800px', padding: '20px' }}>
        <div style={{ backgroundColor: '#fff', border: '1px solid #ccc', borderRadius: '5px', boxShadow: '0 0 10px rgba(0, 0, 0, 0.1)', padding: '20px', marginTop: '20px' }}>
          ...
          <form style={{ width: '100%', boxSizing: 'border-box' }} action="registration_process.php" method="POST">
            ...
            <div style={{ marginBottom: '20px' }}>
              <label style={{ fontWeight: 'bold', display: 'block', marginBottom: '5px' }} htmlFor="studentid">Student ID:</label>
              <input style={{ width: '100%', padding: '8px', border: '1px solid #ccc', borderRadius: '4px', boxSizing: 'border-box', backgroundColor: '#FAEDCD' }} id="studentid" name="studentid" required />
            </div>

            {/* Third Course Selection */}
            <div style={{ marginBottom: '20px' }}>
              <label style={{ fontWeight: 'bold', display: 'block', marginBottom: '5px' }} htmlFor="entry year">Entry Year:</label>
              <input style={{ width: '100%', padding: '8px', border: '1px solid #ccc', borderRadius: '4px', boxSizing: 'border-box', backgroundColor: '#FAEDCD' }} id="entryyear" name="entryyear" required />
                
            </div>

            <div style={{ marginBottom: '20px' }}>
              <label style={{ fontWeight: 'bold', display: 'block', marginBottom: '5px' }} htmlFor="reason">Final Year:</label>
              <input style={{ width: '100%', padding: '8px', border: '1px solid #ccc', borderRadius: '4px', boxSizing: 'border-box', backgroundColor: '#FAEDCD' }} type="finalyear" id="finalyear" name="finalyear" required/>
            </div>
